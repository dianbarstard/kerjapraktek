...
<head>
  ...
  <title>FROM REGISTRASI TVRI JABAR</title>
...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <img src="{{url('AdminLTE-3.1.0/dist/img/TVRIJABAR.png')}}" alt="">
    </div>
    <div class="card-body">
      ...
      {{csrf_field()}}
        ...
        <div class="row">
            <button type="submit" href="{{route('register')}}"class="btn btn-primary btn-block">Register</button>
        </div>
        <p class="mb-0">
