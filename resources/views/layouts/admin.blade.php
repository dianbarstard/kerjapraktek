...
<head>
  ...
  <title>Sistem Informasi Portal Berita TVRI JABAR</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('AdminLTE-3.1.0/dist/img/LOGOTVRIJABAR.png')}}" alt="LOGOTVRIJABAR" height="400" width="400">
  </div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Sistem Informasi Portal Berita TVRI JABAR</h1>
          </div><!-- /.col -->
